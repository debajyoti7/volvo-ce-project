...
public class JDialog_Project extends JDialog {
	...
	public JDialog_Project(JFrame par, List<String> not_available_names, String title, CBRProject p) {
	...
	private void submitForm() {
		...
		if(textField1.getText().equals("")) {
			JOptionPane.showMessageDialog(JDialog_Project.this, "Please give a project name.");
			problems++;
		}
		
		if(! textField1.getText().equals(JDialog_Project.this.old_value) && JDialog_Project.this.not_available_names.contains(textField1.getText())) {
			JOptionPane.showMessageDialog(JDialog_Project.this, "Name already exist.");
			problems++;
		}
		
		if(!new File(textField2.getText()).exists()) {
			JOptionPane.showMessageDialog(JDialog_Project.this, "Dataset is not valid.");
			problems++;
		}
		...
		if(problems == 0) {
			JDialog_Project.this.form_validated = true;
			JDialog_Project.this.setVisible(false);
		}
	}
